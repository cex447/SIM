...
import { occupancyFingerprint, updateOccupancy } from "./occupancy.js?v=3.21.0";
import { countdownState, formatCountdown } from "./time.js?v=3.21.0";
import {
  countdownRedThreshold,
  isOriginHold,
  parentCode
} from "./operations.js?v=3.21.0";
import {
  cachedPlatform,
  clearPlatform,
  fetchIsicStation,
