...
import { decodeCirculation } from "./fgc-api-3.41.0.js";
import {
  getStationCatalog,
  getStationDepartures,
  getTripBundle
} from "./gtfs-3.41.0.js";
import { updateOccupancy } from "./occupancy-3.41.0.js";
import { countdownState, formatOperationalCountdown, resolveGtfsTimestamp } from "./time-3.41.0.js";
import { locateOperationalTarget, parentCode, countdownRedThreshold } from "./operations-3.41.0.js";
import {
  fetchIsicStation,
  fixedPlatformFor,
  fallbackPlatformFor,
...
export function wireISIC(S, { onSelectTrain } = {}) {
  ...
  document.querySelectorAll("[data-isic-station]").forEach(button => {
    button.addEventListener("click", () => {
      input.value = String(button.dataset.isicStation || "").toUpperCase();
      syncISICQuery(S, { blur:true });
    });
  });
}
