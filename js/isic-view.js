import { decodeCirculation } from "./fgc-api.js?v=3.28.0";
import {
  getStationCatalog,
  getStationDepartures,
  getTripBundle
} from "./gtfs.js?v=3.28.0";
import { updateOccupancy } from "./occupancy.js?v=3.28.0";
import { countdownState, formatCountdown, resolveGtfsTimestamp } from "./time.js?v=3.28.0";
import { locateOperationalTarget, parentCode, countdownRedThreshold } from "./operations.js?v=3.28.0";
import {
  fetchIsicStation,
  fixedPlatformFor,
  matchContextsToRows,
...
/* BETA 3.28.0 · una circulación sólo puede existir una vez en iSIC.
...
export function renderISIC(S) {
  ...
  /*
   * BETA 3.28.0 · el estado se decide por sentido.
...
export async function refreshISIC(S, { force = false } = {}) {
  ...
  state.refreshPromise = (async () => {
    ...
    /* BETA 3.28.0: el límite es por línea + sentido, no por sentido global.
