...
import { decodeCirculation } from "./fgc-api-3.43.0.js";
import {
  getStationCatalog,
...
import { countdownState, formatOperationalCountdown, resolveGtfsTimestamp } from "./time-3.43.0.js";
import { locateOperationalTarget, parentCode, countdownRedThreshold } from "./operations-3.43.0.js";
import {
  fetchIsicStation,
  fixedPlatformFor,
  fallbackPlatformFor,
...
function createRow(S, item) {
  ...
  button.append(
    row.turn, row.circulation, row.unit, row.occupancy, row.current,
